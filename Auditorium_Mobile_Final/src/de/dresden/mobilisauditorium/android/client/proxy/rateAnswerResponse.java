...
public class rateAnswerResponse extends XMPPBean {

	private int errortype = Integer.MIN_VALUE;


	public rateAnswerResponse( int errortype ) {
		super();
	...
	public static final String CHILD_ELEMENT = "rateAnswerResponse";
	...
	public XMPPBean clone() {
		rateAnswerResponse clone = new rateAnswerResponse( errortype );
