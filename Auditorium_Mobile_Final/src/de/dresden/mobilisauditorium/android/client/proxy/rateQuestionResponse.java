...
public class rateQuestionResponse extends XMPPBean {

	private int errortype = Integer.MIN_VALUE;


	public rateQuestionResponse( int errortype ) {
		super();
	...
	public static final String CHILD_ELEMENT = "rateQuestionResponse";
	...
	public XMPPBean clone() {
		rateQuestionResponse clone = new rateQuestionResponse( errortype );
