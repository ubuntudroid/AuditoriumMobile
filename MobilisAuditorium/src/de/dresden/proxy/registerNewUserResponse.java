...
public class registerNewUserResponse extends XMPPBean {

	private int errortype = Integer.MIN_VALUE;


	public registerNewUserResponse( int errortype ) {
		super();
	...
	public static final String CHILD_ELEMENT = "registerNewUserResponse";
	...
	public XMPPBean clone() {
		registerNewUserResponse clone = new registerNewUserResponse( errortype );
